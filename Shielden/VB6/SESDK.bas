...
Public Declare Function SEAddMemoryGuard Lib "SESDKDummy.dll" (ByVal pData As Long, ByVal ulSize As Long) As Boolean

Public Declare Function SEDelMemoryGuard Lib "SESDKDummy.dll" (ByVal pData As Long, ByVal ulSize As Long) As Boolean