...
function SEAddMemoryGuard(pData: PChar; Size: Integer): LongBool; stdcall; external SESDKDLL name 'SEAddMemoryGuard';
function SEDelMemoryGuard(pData: PChar; Size: Integer): LongBool; stdcall; external SESDKDLL name 'SEDelMemoryGuard';
